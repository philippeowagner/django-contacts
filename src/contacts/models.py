...
class Company(models.Model):
	...
	note = GenericRelation(Comment, object_id_field='object_pk', related_name="company_notes")
...
class Person(models.Model):
	...
	street_address = GenericRelation('StreetAddress')
	special_date = GenericRelation('SpecialDate')
	note = GenericRelation(Comment, object_id_field='object_pk', related_name="person_notes")
